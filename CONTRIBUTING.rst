...
Welcome to ``atari_menu`` contributor's guide.
...
If you experience bugs or general issues with ``atari_menu``, please have a look
...
You can help improve ``atari_menu`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``atari_menu`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``atari_menu``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n atari_menu python=3 six virtualenv pytest pytest-cov
    conda activate atari_menu
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/atari_menu.git
    cd atari_menu
...
#. Install |pre-commit|_::
   ...
   ``atari_menu`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/atari_menu
.. _issue tracker: https://github.com/<USERNAME>/atari_menu/issues
.. <-- end -->
